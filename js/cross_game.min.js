...
A.append("path").attr("d",d3.svg.symbol().size(350).type(function(t){return"cross"})).attr("id",j).attr("class","cross").attr("transform","translate("+S+","+$+") rotate(45)").attr("fill","red").on("click",function(){"no"==k&&d3.select(this).remove()})}}})
